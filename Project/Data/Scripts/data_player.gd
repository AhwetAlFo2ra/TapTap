...
func _init(p_display_name = "Player Name", p_player_visual = null, p_player_damage = 10, p_unlocked = false, p_projectile_visual = null):
	display_name = p_display_name
	player_visual = p_player_visual
	player_damage = p_player_damage
	unlocked = p_unlocked
	projectile_visual = p_projectile_visual
